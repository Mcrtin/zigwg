...
pub fn build(b: *std.Build) void {
    ...
    mod.addImport("mc-generated", gen_mod);
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "zigwg" is the name you will use in your source code to
                // import this module (e.g. `@import("zigwg")`). The name is
    ...
    b.step("check", "<used by LSPs>").dependOn(test_step);
}
